...
// let TaskAnalytics = require("./task_analytics");
...
if (process.argv[2] !== undefined) {
  switch (process.argv[2]) {
    ...
    case "migratedata":
      ...
      break;
    // case "taskanalytics":
    //   TaskAnalytics(function () {
    //     process.exit();
    //   });
    //   break;
    default:
      console.log(
        process.argv[2] + " not found. Try 'createdb' or 'migratedata' "
      );
      break;
  }
} else
  console.log(
    "No method stated. Try 'node start.js createdb' or 'node start.js migratedata' "
  );
